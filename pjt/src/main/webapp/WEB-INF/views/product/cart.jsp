...
<body>
	...
	<div id="register-form">
		...
		<form id ="cartForm" method="post">
			<button type="submit" id="select_delete" onclick="deleteBtn_click(event);">선택삭제</button>
			<table id="tableTest">
				<tr>
			...
			<div id="submit-button"> 
				<button type="submit" id="order_btn" name="order_btn" onclick="submitBtn_click(event);"><a href="../order/order"  style="color:white;" id="gotohome" >주문하기</a></button>		
			</div>
			</form>
	</div>
